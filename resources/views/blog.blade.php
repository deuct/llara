    ...
    <div class="card mb-3">
        ...
        <div class="card-body text-center">
            ...
            <small class="text-muted">
                <p>By. <a href="/blog?author={{ $posts[0]->author->username }}">{{ $posts[0]->author->name }}</a> in <a href="/blog?category={{ $posts[0]->category->slug }}" class="text-decoration-none"> {{ $posts[0]->category->name }} </a> {{ $posts[0]->created_at->diffForHumans() }}</p>
            </small>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>
                                <small class="text-muted">
                                    <p>By. <a href="/blog?author={{ $post->author->username }}">{{ $post->author->name }}</a> {{ $post->created_at->diffForHumans() }}</p>
                                </small>
                            </p>
